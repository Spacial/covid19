...
- (pt-br) [COVID-19](https://brasil.io/dataset/covid19/boletim): Boletins informativos e casos do coronavírus por município por dia
- (pt-br) [https://www.lagomdata.com.br/coronavirus](https://www.lagomdata.com.br/coronavirus) by lagon data
- [Our world in data covid19 total cases](https://covid.ourworldindata.org/data/total_cases.csv)
...
- [Modeling COVID-19 Spread vs Healthcare Capacity](https://alhill.shinyapps.io/COVID19seir/). repo: [SEIR_COVID19](https://github.com/alsnhll/SEIR_COVID19)
...
- [Coronavirus COVID-19 Global Cases](https://coronavirus.jhu.edu/map.html) by The Center for Systems Science and Engineering (CSSE) at Johns Hopkins University. [Novel Coronavirus (COVID-19) Cases, provided by JHU CSSE](https://github.com/CSSEGISandData/COVID-19)
...
- [Impact of non-pharmaceutical interventions (NPIs) to reduce COVID- 19 mortality and healthcare demand](https://www.imperial.ac.uk/media/imperial-college/medicine/sph/ide/gida-fellowships/Imperial-College-COVID19-NPI-modelling-16-03-2020.pdf), update by author: [Niel Ferguson](https://twitter.com/neil_ferguson/status/1243294815200124928)
- [Observatório COVID-19 BR](https://covid19br.github.io/index.html), [repo](https://github.com/covid19br/covid19br.github.io)
- [COVID19 por regiones de Chile](https://virginiabehm.maps.arcgis.com/apps/opsdashboard/index.html#/12165595ee004f8c84ecba5f89c702fc)
...
- [COVID-19](https://github.com/DmitrySerg/COVID-19): Modelling the disease spread
- [Covid Visualizer](https://www.covidvisualizer.com) with data from [worldometers](https://www.worldometers.info/coronavirus/)
- [Covid Trends](https://aatishb.com/covidtrends/) by Aatish Bhatia, [repo](https://github.com/aatishb/covid)
...
- (pt-br) [Ventiladormaker](https://github.com/GlenLuiz/Ventiladormaker): Ventilador OpenSource para combate ao COVD-19, todos os modelos de ventiladores ainda nao passaram em avaliacoes da ANVISA.
- [Isinnova shares 3D printed adapter to turn snorkeling mask into a non-invasive ventilator](https://www.3dprintingmedia.network/isinnova-shares-3d-printed-adapter-to-turn-snorkeling-mask-into-a-non-invasive-ventilator/)

### Masks

- [PrakashLab COVID19 Response Group](http://web.stanford.edu/group/prakash-lab/cgi-bin/labsite/publications/): 
  * COVID19 – Ventilator Remote Controller Project
  * COVID19 – Full-face “Snorkeling” Mask based reusable PPE
  * COVID19 – Can an N95 mask be sterilized and reused?
- [NANOHACK, THE OPEN SOURCE RESPIRATOR MASK](https://copper3d.com/hackthepandemic/)
- [Polomaska BUT–H1 proti COVID-19](https://www.vutbr.cz/vut/aktuality-f19528/polomaska-but-h1-proti-covid-19-d197642)
...
- [A Case Report in @NatureMedicine shows that #COVID19 is not a laboratory construct or a purposefully manipulated virus.](https://twitter.com/nresearchnews/status/1239952195535147008). [report](https://www.nature.com/articles/s41591-020-0820-9)
...
- [COVID-19 image data collection](https://github.com/ieee8023/covid-chestxray-dataset): We are building an open database of COVID-19 cases with chest X-ray or CT images.
- [ncov-cfr](https://github.com/calthaus/ncov-cfr): R code and documentation to estimate case fatality ratio of COVID-19 from cases outside China
...
- [Using Kalman Filter to Predict Corona Virus Spread](https://github.com/Rank23/COVID19)
- [Folding@home COVID-19 efforts](https://github.com/FoldingAtHome/coronavirus)
- [Welcome to Glacier Data Project. A post-wuhan2020 project for data science](https://github.com/Glacier-Ice/Covid-19-data-science)
- [covidify](https://github.com/AaronWard/covid-19-analysis): corona virus report generation for python
...
- [2019-wuhan-coronavirus-data](https://github.com/globalcitizen/2019-wuhan-coronavirus-data): 2019 Wuhan Coronavirus data (COVID-19 / 2019-nCoV)
...
>>>>>>> 10f29b4bc162b4fa8369d8c9f53c19c000ac79a6
...
- [Everyone In Iceland Can Get Tested For The Coronavirus. Here's How The Results Could Help All Of Us.](https://www.buzzfeed.com/albertonardelli/coronavirus-testing-iceland)
- [COVID-19 Tips](https://github.com/eleanormurray/COVID_19/blob/master/5Tips_Portuguese_Brazil.pdf)
...
- [CORONATRACKER.com](https://www.coronatracker.com) is a community-based project powered by over 460 volunteers from across the globe, ranging from data scientists, medical professionals, UI/UX designers, fullstack developers, to the general public.
- [I've been mulling over the @MRC_Outbreak modeling report on #COVID19 mitigation and suppression strategies since it was posted on March 16. Although mitigation through social distancing may not solve things I believe we can bring this epidemic under control.](https://twitter.com/trvrb/status/1240444839432318976)
- [How to fight the coronavirus SARS-CoV-2 and its disease, COVID-19](https://drive.google.com/file/d/1ZaiDO87me4puBte-8VytcSRtpQ3PVpkK/view) by Michael Lin
- [How to unring the bell: A meta-analytic approach to correction of misinformation](https://www.tandfonline.com/doi/abs/10.1080/03637751.2018.1467564)
- [COVID-19 AND COWORKING: ALL THE FINANCIAL RESOURCES CURRENTLY AVAILABLE GLOBALLY COMPILED INTO ONE ARTICLE](https://blog.coworkies.com/covid-19-and-coworking-useful-resources-globally/)
